...
ENT.DSounds = {}
ENT.DSounds["Attack"] = {"npc/archer/arch_attack1.wav", "npc/archer/arch_attack2.wav"}
ENT.DSounds["Bite"] = {"npc/archer/arch_bite1.wav", "npc/archer/arch_bite2.wav"}
ENT.DSounds["Alert"] = {"npc/archer/arch_alert1.wav", "npc/archer/arch_alert2.wav"}
ENT.DSounds["Death"] = {"npc/archer/arch_die1.wav", "npc/archer/arch_die2.wav", "npc/archer/arch_die3.wav"}
ENT.DSounds["Pain"] = {"npc/archer/arch_pain1.wav", "npc/archer/arch_pain2.wav", "npc/archer/arch_pain3.wav", "npc/archer/arch_pain4.wav"}
ENT.DSounds["Idle"] = {"npc/archer/arch_idle1.wav", "npc/archer/arch_idle2.wav", "npc/archer/arch_idle3.wav"}
...
schdDie:EngTask( "TASK_PLAY_SEQUENCE", ACT_DIESIMPLE )
	...
	if( ( self.FoundEnemy or self.FoundEnemy_fear ) and !self.attacking and convar_ai == 0 ) then
		...
		if( self.enemy and ValidEntity( self.enemy ) and self.enemy:GetPos():Distance( self:GetPos() ) <= self.closest_range ) then
			...
			elseif( self.enemy:GetPos():Distance( Pos ) < self.MeleeDistance and self:HasCondition( 10 ) and !self:HasCondition( 42 ) ) then
				...
				self:AttackMelee(schdMeleeAttack, self.MeleeDistance, sk_archer_bite_value, "archer", Angle( -15, math.Rand(5,-5), math.Rand(5,-5) ), 0.4, 0.6, "" )
