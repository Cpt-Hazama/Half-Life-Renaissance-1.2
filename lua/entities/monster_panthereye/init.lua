...
ENT.possess_viewheight = 65

ENT.DSounds = {}
ENT.DSounds["Jump"] = {"npc/panthereye/p_jump1.wav", "npc/panthereye/p_jump2.wav"}
ENT.DSounds["ClawHit"] = {"npc/panthereye/pclaw_strike1.wav", "npc/panthereye/pclaw_strike2.wav", "npc/panthereye/pclaw_strike3.wav"}
ENT.DSounds["ClawMiss"] = {"npc/panthereye/pclaw_miss1.wav", "npc/panthereye/pclaw_miss2.wav"}
ENT.DSounds["Alert"] = {"npc/panthereye/p_alert1.wav", "npc/panthereye/p_alert2.wav", "npc/panthereye/p_alert3.wav"}
ENT.DSounds["Death"] = {"npc/panthereye/p_die1.wav", "npc/panthereye/p_die2.wav"}
ENT.DSounds["Pain"] = {"npc/panthereye/p_pain1.wav", "npc/panthereye/p_pain2.wav"}
ENT.DSounds["Idle"] = {"npc/panthereye/p_idle1.wav", "npc/panthereye/p_idle2.wav", "npc/panthereye/p_idle3.wav"}
...
function ENT:Attack_Melee()
	...
	local function attack_dmg()
		...
		if !hitentity then self:PlayRandomSound("ClawMiss") else self:PlayRandomSound("ClawHit") end
		self.attacking = false
	end
