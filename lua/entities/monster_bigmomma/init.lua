...
ENT.possess_viewdistance = 180
ENT.possess_viewheight = 300

ENT.possess_viewdistance = 180
ENT.possess_viewheight = 200

ENT.DSounds = {}
ENT.DSounds["Attack"] = {"npc/gonarch/gon_attack1.wav", "npc/gonarch/gon_attack2.wav", "npc/gonarch/gon_attack3.wav"}
ENT.DSounds["Alert"] = {"npc/gonarch/gon_alert1.wav", "npc/gonarch/gon_alert2.wav", "npc/gonarch/gon_alert3.wav"}
...
function ENT:Initialize()
	...
	self:SetUpEnemies( {"npc_fastzombie_torso", "npc_fastzombie",  "npc_poisonzombie", "npc_zombie", "npc_zombie_torso", "npc_zombine", "monster_zombie", "npc_headcrab", "npc_headcrab_black", "npc_headcrab_poison", "npc_headcrab_fast", "monster_babycrab", "monster_headcrab", "monster_gonome", "monster_zombie_barney", "monster_zombie_soldier"} )
	self.enemyTable_fear = { "npc_combinedropship", "npc_combinegunship", "npc_helicopter", "npc_strider", "npc_sniper" }
	self.enemyTable_LI = { "monster_headcrab", "monster_zombie", "npc_fastzombie_torso", "npc_fastzombie", "npc_poisonzombie", "npc_zombie", "npc_zombie_torso", "npc_zombine", "npc_headcrab_black", "npc_headcrab_poison", "npc_headcrab_fast", "npc_headcrab", "monster_babycrab", "monster_gonome" }
