...
ENT.possess_viewheight = 220

ENT.DSounds = {}
ENT.DSounds["Attack"] = {"npc/garg/gar_attack1.wav", "npc/garg/gar_attack2.wav", "npc/garg/gar_attack3.wav"}
ENT.DSounds["FlameRun"] = {"npc/garg/gar_flamerun1.wav"}
ENT.DSounds["Alert"] = {"npc/garg/gar_alert1.wav", "npc/garg/gar_alert2.wav", "npc/garg/gar_alert3.wav"}
ENT.DSounds["Breath"] = {"npc/garg/gar_breathe1.wav", "npc/garg/gar_breathe2.wav", "npc/garg/gar_breathe3.wav"}
ENT.DSounds["Death"] = {"npc/garg/gar_die1.wav", "npc/garg/gar_die2.wav"}
ENT.DSounds["Pain"] = {"npc/garg/gar_pain1.wav", "npc/garg/gar_pain2.wav", "npc/garg/gar_pain3.wav"}
ENT.DSounds["Idle"] = {"npc/garg/gar_idle1.wav", "npc/garg/gar_idle2.wav", "npc/garg/gar_idle3.wav", "npc/garg/gar_idle4.wav", "npc/garg/gar_idle5.wav"}
...
function ENT:Initialize()
	...
	self:SetUpEnemies({"monster_babygarg"})
