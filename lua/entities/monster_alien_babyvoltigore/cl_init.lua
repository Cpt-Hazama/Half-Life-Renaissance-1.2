...
language.Add("monster_alien_babyvoltigore", "Baby Voltigore")
killicon.Add("monster_alien_babyvoltigore","HUD/killicons/monster_alien_babyvoltigore",Color ( 255, 80, 0, 255 ) )
