...
function ENT:Initialize()
	...
	self:SetUpEnemies( {"npc_gman", "monster_gman", "npc_alyx", "npc_barney", "npc_citizen", "npc_vortigaunt", "npc_monk", "npc_breen", "npc_dog", "npc_eli", "npc_fisherman", "monster_scientist", "monster_sitting_scientist", "npc_kleiner", "npc_magnusson", "npc_mossman", "player", "npc_dobermann"} )
...
function ENT:Attack()
	...
	local AttachAngPos = self:GetAttachment( 1 )
	
	local enemy_pos = self.enemy:GetPos() +self:GetPositionAnomaly(self.enemy:GetClass())
	...
	effectdata:SetAngle( AttachAngPos["Ang"] )
