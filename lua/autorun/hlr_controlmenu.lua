function GetAllNPCClasses()
	local npcs = {"monster_alien_babyvoltigore", "monster_alien_controller", "monster_alien_grunt", "monster_alien_slave", "monster_alien_slave", "monster_alien_voltigore", "monster_archer", "monster_babycrab", "monster_babygarg", "monster_barney", "monster_bigmomma", "monster_bullchicken", "monster_cockroach", "monster_gargantua", "monster_gman", "monster_gonome", "monster_headcrab", "monster_houndeye", "monster_human_assassin", "monster_human_grunt", "monster_hwgrunt", "monster_ichthyosaur", "monster_nihilanth", "monster_panthereye", "monster_parasite", "monster_penguin", "monster_pitdrone", "monster_scientist", "monster_snark", "monster_zombie", "monster_zombie_barney", "monster_zombie_soldier", "npc_mortarsynth", "npc_stukabat"}
...
if SERVER then
	...
	function HLR_MENUPANEL_SPEC_NPCSOURCE_FOLLOW(ply, cmd, args)
		if !ValidEntity(HLR_MENUPANEL_SPEC_NPCSOURCE) or !ValidEntity(HLR_MENUPANEL_SPEC_NPCTARGET) then return end
	...
	function HLR_MENUPANEL_SPEC_NPCSOURCE_POSSESS(ply, cmd, args)
		if !ValidEntity(HLR_MENUPANEL_SPEC_NPCSOURCE) then return end
		local npc = HLR_MENUPANEL_SPEC_NPCSOURCE
		ply:PossessNPC(npc)
		...
		timer.Simple(2, function() if ValidEntity(ply) then ply:SendLua("GAMEMODE:AddNotify(\"To stop the possession, press your jump key!\", NOTIFY_HINT, 5)") end end)
	end
