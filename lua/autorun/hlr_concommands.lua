...
sk_controller_fly_speed_value = 125
...
// BABY GARGANTUA
function sk_babygarg_health( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_babygarg_health_value = v
		end
	end
end 
concommand.Add( "sk_babygarg_health", sk_babygarg_health )

sk_babygarg_health_value = 800

function sk_babygarg_slash_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_babygarg_slash_value = v
		end
	end
end 
concommand.Add( "sk_babygarg_dmg_slash", sk_babygarg_slash_dmg )

sk_babygarg_slash_value = 21

function sk_babygarg_burn_pl_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_babygarg_burn_pl_value = v
		end
	end
end 
concommand.Add( "sk_babygarg_dmg_fire", sk_babygarg_burn_pl_dmg )

sk_babygarg_burn_pl_value = 18

function sk_babygarg_burn_npc_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_babygarg_burn_npc_value = v
		end
	end
end 
concommand.Add( "sk_babygarg_dmg_fire_npc", sk_babygarg_burn_npc_dmg )

sk_babygarg_burn_npc_value = 10

function sk_babygarg_kick_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_babygarg_kick_value = v
		end
	end
end 
concommand.Add( "sk_babygarg_dmg_kick", sk_babygarg_kick_dmg )

sk_babygarg_kick_value = 20
...
// NIHILANTH
function sk_nihilanth_health( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_nihilanth_health_value = v
		end
	end
end 
concommand.Add( "sk_nihilanth_health", sk_nihilanth_health )

sk_nihilanth_health_value = 1400

function sk_nihilanth_attack_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_nihilanth_attack_value = v
		end
	end
end 
concommand.Add( "sk_nihilanth_dmgball", sk_nihilanth_attack_dmg )

sk_nihilanth_attack_value = 6
...
function sk_stukabat_health( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
...
concommand.Add( "sk_stukabat_health", sk_stukabat_health )

sk_stukabat_health_value = 160

function sk_stukabat_claw_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_stukabat_claw_value = v
		end
	end
end 
concommand.Add( "sk_stukabat_claw_dmg", sk_stukabat_claw_dmg )

sk_stukabat_claw_value = 38
...
// MORTARSYNTH
function sk_msynth_health( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_msynth_health_value = v
		end
	end
end 
concommand.Add( "sk_mortarsynth_health", sk_msynth_health )

sk_msynth_health_value = 200

function sk_msynth_beam_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_msynth_beam_value = v
		end
	end
end 
concommand.Add( "sk_mortarsynth_dmg_beam", sk_msynth_beam_dmg )

sk_msynth_beam_value = 25

// DOBERMANN
function sk_dog_health( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_dog_health_value = v
		end
	end
end 
concommand.Add( "sk_dog_health", sk_dog_health )

sk_dog_health_value = 80

function sk_dog_bite_dmg( player, command, arguments )
	if GetConVarNumber("sv_cheats") == 1 then
		for k,v in pairs( arguments ) do
			sk_dog_bite_value = v
		end
...
concommand.Add( "sk_dog_dmg_bite", sk_dog_bite_dmg )

sk_dog_bite_value = 24